...
| 内容 | 当前覆盖 | 建议吸收方式 |
| --- | --- | --- |
| 止损反推数量、初始风险、当前风险、整笔损益 | [Trade 3.6–3.7](../../trading_system/trade.md) 已有 | 沿用现有定义；以 PM01、PM06 和算例作来源支撑 |
| 最大层数、预留预算、共同止损、增量判断 | [Trade 第四节](../../trading_system/trade.md) 已有 | 沿用共用规则；补 PM03–PM05 的不同市场资格 |
| 首仓波段、后层短线；动能失败减仓 | [Trade 4.1](../../trading_system/trade.md) 已有用途分工 | 以 PM08 补充重叠、平缓通道及跟随转弱的触发 |
| 目标兑现、当前风险减仓、高潮减仓 | [Trade 3.5–3.6](../../trading_system/trade.md) 已有原则 | 按 PM06–PM10 补条件与余仓去向 |
| 首次突破测试与恢复后再次测试 | [Trade 3.4](../../trading_system/trade.md) 已有止损约束 | 以 PM13 补判断时点；近似保本价仍核对结构与成本 |
| 前提失效、止损成交、退出未成交 | [Trade 第五节](../../trading_system/trade.md)、[Account](../../trading_system/account.md) 已有 | 用 PM15–PM17 对照场景与订单事实，统一余仓数量 |
| 原交易退出后再入、反向新交易 | [Trade](../../trading_system/trade.md) 已有新方案核算 | 保留旧结果，补 PM18 的原背景恢复 / 反向新依据分支 |
| 日内分层的时间资格 | [Trade 3.5](../../trading_system/trade.md) 已有期限对象 | 用 PM19 补“回摆所需时间与剩余时段”的具体关系 |
