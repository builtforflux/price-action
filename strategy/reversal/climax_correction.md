# 高潮后修正（Climax / Exhaustion）

> **状态：Strategy / Application**
>
> 本文把逆势修正家族实例化为高潮式推进后的修正；它不生成具体订单参数。
...
| 语境 | 先验 |
| --- | --- |
| 晚段趋势大突破/连续高潮组合 | 约 60% 反转或原趋势结束 |
| 晚段五根以上小 K 线微型通道 | 约 70% TBTL、约 30% continuation |
| 紧通道持续约 20 根后进入高潮 | 约 70% 出现至少约 20 根、两腿的横向至反向调整（主要是 trading range 和 minor reversal，不是 opposite trend） |
