...
| 名称 | 最低边界 | 成立时点 |
| --- | --- | --- |
| Opening / session gap | 必须声明参考边界。Glossary 指第一根开盘越过昨日最后一根或整个昨日范围；课程实务还分别追踪昨日 close、closing range、昨日 high/low，并在首根完成后用当日 low/high 更新仍开放的区间 | 对所选边界的几何事实可在相应时点确认；不能折叠成一个未注明参照的布尔标签 |
...
| Exhaustion gap | 存在来源口径差异：glossary 要求趋势后期异常顺势运动后至少出现小反转；课程案例也把只停止顺势压力并转为横盘、gap 到收盘仍开放的末端状态称为 exhaustion | 大 K 线出现时只能称 potential exhaustion；结果出现后记录采用的口径以及实际是反转还是仅停止延续 |
...
相关来源见 [`reference/official_sources.md`](../../reference/official_sources.md) 中的 `SRC-GLOSSARY`、`SRC-STRONG-LEGS-2016`、`SRC-OPENING-REVERSALS-2017`、`SRC-PATTERNS-OPEN-2018`、`SRC-LIVE-TR-BO-2021`、`SRC-COURSE-01-36`（课程 10A–11D，其中 11C p691–695 区分 Gap Open Bar、相邻完整 K 线缺口与微缺口；15E、29A–29C）与 `SRC-COURSE-37-52`（课程 42A–42B、48F）。
