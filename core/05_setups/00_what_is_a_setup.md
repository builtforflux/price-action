...
相关来源见 [`reference/official_sources.md`](../../reference/official_sources.md) 中的 `SRC-GLOSSARY`、`SRC-MANUAL`、`SRC-10-PATTERNS`、`SRC-STOP-ORDERS`、`SRC-RISK-113`、`SRC-COURSE-01-36`（课程 08D、13A–13C、21A–21D、30A–30E）与 `SRC-COURSE-37-52`（课程 37A–37B、49A–49E）。
